...
BENCH_FLAGS      = -DSPEC_AUTO_BYTEORDER=0x12345678 -DHAVE_CONFIG_H=1 -DSPEC_MEM_IO -DSPEC_XZ -DSPEC_AUTO_SUPPRESS_OPENMP -I. -Ispec_mem_io -Isha-2 -Icommon -Iliblzma/api -Iliblzma/lzma -Iliblzma/common -Iliblzma/check -Iliblzma/simple -Iliblzma/delta -Iliblzma/lz -Iliblzma/rangecoder
...
commandexe       = xz_r_base.mytest-m64
...
log_line_width   = 1020
log_timestamp    = 0
logfile          = /usr/cpu2017/tmp/CPU2017.014/templogs/preenv.intrate.014.0
logname          = /usr/cpu2017/tmp/CPU2017.014/templogs/preenv.intrate.014.0
lognum           = 014.0
mail_reports     = all
mailcompress     = 0
mailmethod       = smtp
...
notes_plat_sysinfo_010 =  running on chen Wed Aug  5 09:47:17 2020
...
notes_plat_sysinfo_165 =       CPU MHz:               2714.718
...
path             = /usr/cpu2017/benchspec/CPU/557.xz_r
plain_train      = 1
platform         = 
power            = 0
...
review           = 0
run              = all
runcpu           = /usr/cpu2017/bin/harness/runcpu --configfile mytest --size test --fake --action run --noreportable --nopower --runmode rate --tune base --size test 500.perlbench_r 502.gcc_r 505.mcf_r 525.x264_r 557.xz_r 999.specrand_ir --nopreenv --note-preenv --logfile /usr/cpu2017/tmp/CPU2017.014/templogs/preenv.intrate.014.0 --lognum 014.0 --from_runcpu 2
rundir           = run
runmode          = rate
safe_eval        = 1
save_build_files = 
...
srcalt           = 
srcdir           = src
srcsource        = /usr/cpu2017/benchspec/CPU/557.xz_r/src
stagger          = 10
