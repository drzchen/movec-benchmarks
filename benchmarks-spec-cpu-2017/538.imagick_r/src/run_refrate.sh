/usr/bin/time src/imagick_r -limit disk 0 ../data/refrate/input/refrate_input.tga -edge 41 -resample 181% -emboss 31 -colorspace YUV -mean-shift 19x19+15% -resize 30% refrate_output.tga > refrate_convert.out 2> refrate_convert.err
