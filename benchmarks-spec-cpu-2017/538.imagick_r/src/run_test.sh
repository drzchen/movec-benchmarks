/usr/bin/time src/imagick_r -limit disk 0 ../data/test/input/test_input.tga -shear 25 -resize 640x480 -negate -alpha Off test_output.tga > test_convert.out 2> test_convert.err
