...
NUMBER=525
NAME=x264_r
SOURCES= ldecod_src/nal.c ldecod_src/mbuffer_mvc.c ldecod_src/image.c \
	 ldecod_src/mb_access.c ldecod_src/memalloc.c ldecod_src/mc_prediction.c \
	 ...
	 ldecod_src/parsetcommon.c ldecod_src/erc_do_p.c ldecod_src/loopFilter.c \
	 ldecod_src/intra16x16_pred_mbaff.c ldecod_src/intra4x4_pred_normal.c \
...
log_line_width   = 1020
log_timestamp    = 0
logfile          = /usr/cpu2017/tmp/CPU2017.025/templogs/preenv.intrate.025.0
logname          = /usr/cpu2017/tmp/CPU2017.025/templogs/preenv.intrate.025.0
lognum           = 025.0
mail_reports     = all
mailcompress     = 0
mailmethod       = smtp
...
notes_plat_sysinfo_010 =  running on chen Thu Aug  6 00:50:17 2020
...
notes_plat_sysinfo_165 =       CPU MHz:               2756.812
...
notes_plat_sysinfo_475 =     /dev/sda6      ext4   33G  9.6G   22G  32% /
...
path             = /usr/cpu2017/benchspec/CPU/525.x264_r
plain_train      = 1
platform         = 
power            = 0
...
review           = 0
run              = all
runcpu           = /usr/cpu2017/bin/harness/runcpu --configfile mytest --action build --noreportable --nopower --runmode rate --tune base --size refrate 525.x264_r --nopreenv --note-preenv --logfile /usr/cpu2017/tmp/CPU2017.025/templogs/preenv.intrate.025.0 --lognum 025.0 --from_runcpu 2
rundir           = run
runmode          = rate
safe_eval        = 1
save_build_files = 
...
srcalt           = 
srcdir           = src
srcsource        = /usr/cpu2017/benchspec/CPU/525.x264_r/src
stagger          = 10
