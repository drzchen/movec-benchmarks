...
/usr/bin/time src/x264_r --pass 1 --stats x264_stats.log --bitrate 1000 --frames 1000 -o BuckBunny_New.264 BuckBunny.yuv 1280x720 > x264_r_000-1000_pass1.out 2> x264_r_000-1000_pass1.err
/usr/bin/time src/x264_r --pass 2 --stats x264_stats.log --bitrate 1000 --dumpyuv 200 --frames 1000 -o BuckBunny_New.264 BuckBunny.yuv 1280x720 > x264_r_000-1000_pass2.out 2> x264_r_000-1000_pass2.err
/usr/bin/time src/x264_r --seek 500 --dumpyuv 200 --frames 1250 -o BuckBunny_New.264 BuckBunny.yuv 1280x720 > x264_r_500-1250.out 2> x264_r_500-1250.err
