#!/bin/bash
# You may use command arguments: refrate, O1, O2, O3, clean.

## Set the RUN type: test or refrate
RUN="test"
if [[ $* =~ "refrate" ]]; then RUN="refrate"; fi
## Set the file prefix
PREF=SPEC-${RUN}
...
SKIP_DIRS_MOVEC_On="500.perlbench_r 502.gcc_r"
